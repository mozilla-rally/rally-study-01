...
| --- | --- | --- | --- | --- | --- | --- |
| rally.id |[uuid](https://mozilla.github.io/glean/book/user/metrics/uuid.html) |The id of the Rally client. This is generated by the Rally Core Add-on.  |[mozilla-rally/rally-core-addon#505](https://github.com/mozilla-rally/rally-core-addon/pull/505#issuecomment-815826426)||never | |
...
- `study-enrollment`: The user has enrolled in this study.
...
| Name | Type | Description | Data reviews | Extras | Expiration | [Data Sensitivity](https://wiki.mozilla.org/Firefox/Data_Collection) |
| --- | --- | --- | --- | --- | --- | --- |
| study_enrollment.enrolled_on |[datetime](https://mozilla.github.io/glean/book/user/metrics/datetime.html) |When the user enroll in this study.  |[Review 1](forthcoming)||never | |
| study_enrollment.id |[uuid](https://mozilla.github.io/glean/book/user/metrics/uuid.html) |The id of the Rally client. This is generated by the Rally Core Add-on.  |[Review 1](forthcoming.)||never | |
